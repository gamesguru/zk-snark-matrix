...
Using zero-knowledge proofs generated by tools like Succinct Labs' `sp1` or a16z's `jolt`, homeservers can generate proof of "correct code execution" of a fixed program (uniquely identified by Merkle root) over a room's DAG.
